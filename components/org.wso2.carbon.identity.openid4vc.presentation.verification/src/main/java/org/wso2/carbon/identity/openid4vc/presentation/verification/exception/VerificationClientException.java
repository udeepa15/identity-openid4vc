...
public class VerificationClientException extends VerificationException {
    ...
    /**
     * Creates a new client exception with the given error code and a short message.
     *
     * @param errorCode The structured error code (must not be null).
     * @param message   A concise, developer-facing message.
     */
    public VerificationClientException(VerificationErrorCode errorCode, String message) {
        super(errorCode, message);
    }

    /**
     * Creates a new client exception with the given error code, message, and root cause.
     *
     * @param errorCode The structured error code (must not be null).
     * @param message   A concise, developer-facing message.
     * @param cause     The underlying exception.
     */
    public VerificationClientException(VerificationErrorCode errorCode, String message, Throwable cause) {
        super(errorCode, message, cause);
    }

    /**
     * Creates a new client exception with the given error code, message, and a custom description.
     *
     * @param errorCode   The structured error code (must not be null).
     * @param message     A concise, developer-facing message.
     * @param description A detailed, user-facing description that overrides the code's default.
     */
    public VerificationClientException(VerificationErrorCode errorCode, String message, String description) {
        super(errorCode, message, description);
    }

    /**
     * Creates a new client exception with the given error code, message, custom description, and root cause.
     *
     * @param errorCode   The structured error code (must not be null).
     * @param message     A concise, developer-facing message.
     * @param description A detailed, user-facing description that overrides the code's default.
